# Early-adopter endorsement

- **Archetype**: Credentialed early adopter endorses a product through their own documented usage
- **Funnel stage**: BOFU — converts existing intent.
- **Stage mechanic**: A user with professional standing (a VC, a CTO) lists exactly what they personally did with the product — the itemized usage is the proof, the dual-identity frame ("as a VC… as a human") is the endorsement's credibility engine.
- **Platform**: LinkedIn
...
- **Skeleton** (block sequence):
  ...
  2. Dual-identity frame ("As a {professional role}… As a human…")
  3. Usage receipts: dash list of what the author actually did/underwent
  4. "Why?" — the belief that motivated the usage
  5. What the company is building (the author's own words, not the brand's)
  6. Thesis close (the category's future) + personal stake line
- **Rhythm & formatting**: 180–250 words. The usage list is the spine — concrete, slightly effortful items (wore the monitor, did the MRI). One emoji tolerated.
- **Why it works**: Usage costs time and body; listing it proves the endorsement is lived, not paid. The dual-identity frame preempts "he's just an investor talking his book" by making the personal stake explicit.
