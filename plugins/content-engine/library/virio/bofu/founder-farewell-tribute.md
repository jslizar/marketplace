# Founder farewell tribute

- **Archetype**: Executive honors a departing founder/leader, itemizing their legacy
- **Funnel stage**: BOFU — converts existing intent.
- **Stage mechanic**: At leadership transitions — exactly when buyers and partners get nervous — a tribute that itemizes the departing leader's institutionalized contributions (the products, the disciplines, the institute) signals continuity: the genius is built into the company now.
- **Platform**: LinkedIn
...
- **Skeleton** (block sequence):
  ...
  2. Direct address to the honoree: what made them singular, in craft terms
  3. Personal thread: how the author's own path crossed theirs (the PhD student detail)
  4. Legacy itemization: the named things they built/introduced (HANA, design thinking) — each a still-living asset
  5. Continuity close: what carries forward
- **Rhythm & formatting**: 200–280 words. Formal-warm. Second person to the honoree, audience listening in. Photo from the event.
- **Why it works**: Succession anxiety is a real deal-killer in enterprise sales. Itemized, named legacy converts "we lost our genius" into "our genius became infrastructure" — while the personal thread keeps it human.
