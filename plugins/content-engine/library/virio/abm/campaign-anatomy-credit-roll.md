...
- **Skeleton**:
  ...
  2. Dated timeline of the brand's run (year-by-year lines: founding → funding → product gens → valuation → the news peg)
  3. Campaign elements as arrow bullets (films, placements, partnerships, OOH, experiential — concrete names and cities)
  4. Credit roll: "The {agency} team behind this:" — each person with role + one-line résumé line ("ex-Goodby Silverstein", "Rated number one strategist in North America")
  5. Counterpart credit roll for the brand-side team
  6. Congrats closer + personal action ("running to get my ring")
...
Source: https://www.linkedin.com/posts/david-heinemeier-hansson-374b18221_our-s3-exit-is-slated-for-this-summer-thats-activity-7308840098773577728-G7pC (DHH, 7,465 reactions)

```
Our S3 exit is slated for this summer. That's when our 4-year contract expires. That contract is worth $1.2 million per year. So just about five million over the duration. It was a little more than a third of our combined cloud bill, before we pulled out compute, databases, and the rest, as part of our cloud exit. Real Money™!

In anticipation, we've been building out a 18 petabyte storage cluster using flash-drive hardware from Pure Storage. The hardware build-out is about $1.5 million. Just slightly more than we were paying for 1 year's rent of about half the capacity on S3!

The Pure setup is super compact, so we could fit it inside our existing data center racks. It also sips power compared to hard drive-based storage. So we didn't even need to bump our power commits. That turned out to make all the difference when comparing bids from other providers using hard drives. And nobody could get close to the NVMe prices that Pure were able to offer (most came in at 2x or higher!!).
