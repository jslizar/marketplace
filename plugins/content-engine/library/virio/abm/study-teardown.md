...
- **Source examples**: (refreshed by the scheduled library-refresh task; pinned entries never auto-replaced)
  ...
  - https://www.linkedin.com/posts/alexwang2911_mckinsey-company-studied-150-genai-initiatives-activity-7347249782169485312-weCt — Alex Wang, 3,463 reactions, Jul 2025 (McKinsey 150+ GenAI initiatives)
- **Hook pattern**: "There's something almost nobody is talking about in {space}" / "{org} studied {n} {things}, and surfaced one key pattern:"
- **Skeleton**:
  1. Curiosity-gap hook (the overlooked finding)
  2. Name the study and its scale (n, scope — the credibility line)
  3. The result in one or two crisp lines
  4. "Why does this matter?" — one concrete scenario played out (a real company situation, step by step)
  5. Contrast case showing where the default breaks
...
Source: https://www.linkedin.com/posts/teybannerman_theres-something-almost-nobody-is-talking-activity-7358405153139367937-4GVf (Tey Bannerman, 9,882 reactions)
