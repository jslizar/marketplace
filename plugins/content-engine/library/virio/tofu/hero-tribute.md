...
- **Archetype**: Personal tribute to a widely admired figure, anchored in one vivid, unexpected detail
- **Funnel stage**: TOFU — earns reach with the ICP; client-agnostic on the surface.
- **Stage mechanic**: Rides a cultural moment (a passing, an anniversary, an award) with a tribute that teaches something new about a person everyone thinks they know. The unexpected detail ("a Guinea worm's worst nightmare") is what gets quoted.
- **Platform**: LinkedIn
...
- **Skeleton** (block sequence):
  ...
  2. Personal angle: how the author knew them / their work
  3. The proof paragraph: one quantified before/after of their impact (3.5M cases → single digits)
  4. Character close-up: a habit or belief that explains the numbers
  5. Borrowed-wisdom close (a teaching or quote) + what honoring them means
- **Rhythm & formatting**: 180–240 words. Warm, dignified prose. One stat pair does the heavy lifting. No hashtags, no CTA.
- **Why it works**: Everyone posts tributes; almost nobody teaches in one. The surprising specific + the stat pair make this the tribute people share instead of writing their own.
